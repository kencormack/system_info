...
then
  ...
  then
    ...
    fnSUB_BANNER "Checking supplemental software dependencies..."
...
#---------------
# SUPPLEMENTAL MODULE
# Logic in this module was shamelessly based on syslogconf,
# by Michael Hill, Lockheed Martin Astronotics, Denver, CO
# The perl was preserved because bash sucks at nested associative arrays.
