...
then
  ...
  # March 2020, boot-from-USB is promised in a future EEPROM update,
  # as they focus on stabilizing boot-from-network, first.
  if type -path vcgencmd >/dev/null 2>&1
  then
  ...
  # Older Pi models use OTP (One Time Programable) memory to control
