...
be made to back-port this to older versions of Raspbian, nor will I port this to Ubuntu, OSMC, LibreELEC, or any
...
My primary development Pi, an early 2GB 4B (rev a03111), has been upgraded to an 8GB model.
The 2GB Pi has taken over for the failed 3B+.
...
As 2.52 is likely not to work on later models such as the CM4 or new Pi 400, and as WiringPi is now deprecated,
I do not call upon it when examining the later models.  The Pi 4B variants will still be examined, if WiringPi
2.52 is found to be installed.  The Pi 400 and CM4, however, will not.
...
On my development system (hostname "pi-dev"), an example report run on 2020 Dec 28, at 10:39:51 AM, would be named:
/home/pi/pi-dev-system_info-20201228-103951
...
**hostname: pi-max (Development & Test System)**
...
**hostname: pi-2gb (My Secondary Test System)**
