...
symbolic links to /usr/bin, /usr/lib, and /usr/sbin, respectively.

2. Under Raspbian, /tmp was a ram-based tmpfs filesystem.  Under Raspberry Pi OS, /tmp is simpke directory on the
