...
hardware is any variant or model of Pi (except the Pico), from the original Model B, through and including the Pi
4B in all it's available memory configurations (1/2/4/8GB), the 400, and CM4.
