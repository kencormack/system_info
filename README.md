...
the 400, and CM4.  Supported OS versions include Raspbian Stretch, and Buster (including the newly renamed "Raspberry
Pi OS", in 32-bit versions).  Expect things not to work on the 64-bit OS, while it is still beta.  No attempts will
...
If you write your own shell scripts, or like to modify system_info to suit your own needs, see the file
