...
If you have a raspberry pi 4B, install version 2.52 of wiringpi, see:
[http://wiringpi.com/wiringpi-updated-to-2-52-for-the-raspberry-pi-4b/](http://wiringpi.com/wiringpi-updated-to-2-52-for-the-raspberry-pi-4b/).  I do not know if version 2.52 works with the new 8GB variant of the Pi 4B, and as wiringpi is now deprecated, I will discontinue using wiringpi (or at least not call upon it when examining an 8GB Pi 4B in this script), at some point. 
