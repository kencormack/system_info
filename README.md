...
I do not call upon it when examining the later models.  All Pi 4B variants will still be examined, if WiringPi
...
the script (unless the commandline options "-m" or "--menu" are used.)
