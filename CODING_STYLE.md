...
- Two tools that I use regularly while maintaining this script include
  shellcheck to spot fat-fingered coding errors, and beautysh to keep
  things formatted as intended.
