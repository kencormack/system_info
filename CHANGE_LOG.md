...
NOTE: As I no longer have a system running "Stretch", this
will be the last version of system_info formally supporting
that OS release.  Existing functionality will continue to
work under Stretch, but compatibility with any new features
added to system_info beyond this point, is not guaranteed.
